% Runs Anti-flow line on downsteam (grounding line) cross section. Adjust bed properties for
% geometry and peak flow speed. Change driving force too.
...
beta_var = 0e6;%5E6;
beta = 0e6;%2.9E6;
rock_trans = 40e3;%10E3;
sed_const = 19e3;%19.4E3;
sed_var = 8E3;
sed_trans_l = -19e3;%-23E3;
sed_trans_r = 128e3;%71E3;
ch_str = 24.5E3;
ch_decay = 5.9E3;
ch_loc = 10E3;
...
% profile_along = profile_along(:,3);
% profile_path  = profile_path(:,3);

figure 

[hice, hbed, hwater] = bedmap2_profile(profile_lat(:,1),profile_lon(:,1));
ylabel('Elevation [m]')
...
legend('measures main','measures gl','model')
% axis([-30E3,80E3,0,400])

subplot(2,1,2)
plot(profile_path(:,2)-30.5E3,gradient(profile_cross(:,2)),'LineWidth',3)
hold on
