...
Limitations:
This code is currently intended to run on a Mac machine, or a linux server (like Sherlock). Running it on a Windows machine is not supported but should work fine.